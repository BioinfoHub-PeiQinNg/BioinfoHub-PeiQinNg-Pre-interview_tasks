...
```{r, warning = FALSE, message = FALSE}
#test function output generation
...
out2 <-fun.lookfornames(mock.table_1) 
...
out3 <-fun.lookfornames(mock.table_3) 
...
```
The ouput of the code above gives the dataframe as below:
```{r, echo = FALSE}
head(df)
```
